...
print("\nThe fastest you can solve this game is in {number_of_moves} moves".format(number_of_moves=num_optimal_moves))
#Get User Input
def get_input():
    choices = [first_letter.name[0] for first_letter in stacks]
    while True:
